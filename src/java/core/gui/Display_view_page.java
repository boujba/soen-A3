 ...
 * @author User
 */
@WebServlet(name = "Display_view_page", urlPatterns = {"/Display_view_page"})
public class Display_view_page extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //   }
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("ViewBookDetail2.jsp");
